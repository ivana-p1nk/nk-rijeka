...
<template>
    <div v-if="cartStore.cart_products.length > 0" class="px-12 py-10 bg-white shadow-lg rounded-2xl">
        ...
        <div v-for="(item, index) in cartStore.cart_products" :key="index"
            ...
            <div class="flex items-center space-x-2">
                <div class="flex items-center p-1 space-x-1 rounded-lg bg-slate-100">
                    ...
                    <input class="w-5 text-center" type="text" :value="item.orderQuantity" :v-model="item.orderQuantity"
                        disabled />
            ...
            <!-- DELETE -->
            <div>
                <UIcon name="heroicons:trash" class="h-6 ml-3 cursor-pointer w-7"
