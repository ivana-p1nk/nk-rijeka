    ...
    <div class="container mx-auto px-5 pt-32 pb-20">
        ...
        <div class="grid grid-cols-2 gap-10 pt-32">
            ...
            <div class="px-7 pb-7">
                ...
                <div class="flex flex-col gap-3 my-7 py-7 border-y border-neutralBlue-100">
                    <div class="flex flex-row gap-3">
                        <p class="font-semibold text-blue-900 font-saira text-h4-normal">{{
                            product.price.toFixed(2).replace('.', ',') }} €</p>
                        <p
                    ...
                    <div class="flex flex-row gap-3">
                        <p class="font-semibold text-blue-300 font-saira text-h4-normal">{{
                            product.member_price.toFixed(2).replace('.', ',') }} €</p>
                        <p
                ...
                <div class="pt-6 pb-7">
                    <p class="font-normal text-blue-900 font-roboto text-body3">* Personalizacija dresova i hlačica
                        tiska se po fontu sezone 2024/25<br><br>
