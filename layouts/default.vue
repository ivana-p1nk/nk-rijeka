    ...
    <div>
        ...
        <!-- FOOTER -->
         <footer class="mx-auto frame-p border-t-2 bg-cover bg-top bg-[linear-gradient(180deg,rgba(0,25,38,0)_30%,rgba(0,25,38,0.4)_60%,rgba(0,25,38,1)_95%),url(/assets/images/Footer-bg-2.jpg)]">
            ...
            <div class="pt-32">
                ...
                <div class="mx-auto max-w-[1480px] grid grid-cols-1 text-center sm:text-left sm:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-6 gap-6">
                    ...
                    <div class="ml-10 max-lg:ml-0">
                        ...
                        <NuxtLink to="/fan-shop">Fan Shop HNK Rijeka</NuxtLink>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <NuxtLink to="/dostava">Dostava unutar RH</NuxtLink>
                        </p>
                        <p class="footer-text link">
                        <NuxtLink to="/medunarodna-dostava">Međunarodna dostava</NuxtLink>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="footer-text link mb-4">
                        <NuxtLink to="/nacin-placanja">Način plaćanja</NuxtLink>
                        </p>
                        <p class="footer-text link mb-4">
            ...
            <div class="mx-auto p-6 flex flex-col-reverse gap-5 sm:flex-row sm:gap-0 items-center justify-between border-t border-blue-800">
